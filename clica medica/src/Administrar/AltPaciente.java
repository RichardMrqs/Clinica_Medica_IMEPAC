 ...
 * @author Usuário
 */
public class AltPaciente extends javax.swing.JFrame {

    /**
     * Creates new form AltPaciente
     */
    public AltPaciente() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Alterar dados paciente");
        ...
        jLabel5.setText("Alterar endereço:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AltPaciente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AltPaciente().setVisible(true);
            }
        });
    }
